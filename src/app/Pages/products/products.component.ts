...
export class ProductsComponent implements OnInit {
  ...
  selectedAudio1 : any;
  Banner: any = 'http://54.153.8.140:3000/api/uploads/unnamed.jpg';
  title : any = '';
  vendor_id :any = '';
  banner_list : any ;
  ...
  cat_title : any = '';
  cat_descri : any = '';
  cat_image_path : any = 'http://54.153.8.140:3000/api/uploads/unnamed.jpg';
  ...
  fileupload1(event){
    ...
    Img.onload = (e: any) => {
      ...
      if((height !== 160) && (width !== 425)){
       alert('Please upload the valid height and widht. 160 X 425');
      }else {
...
Save2(){
  ...
  if(this.Banner == 'http://54.153.8.140:3000/api/uploads/unnamed.jpg'){
    check = 1;
...
editbanneraction(){
  ...
  if(check == 1){
    ...
    if(this.banner_ref == this.Banner){
      ...
      this._api.banner_edit(a).subscribe(
        (response: any) => {
          ...
          this.ngOnInit();
          this.Banner = 'http://54.153.8.140:3000/api/uploads/unnamed.jpg';
          this.title = '';
    ...
    console.log(fd)
    this.http.post('http://54.153.8.140:3000/upload', fd)
    .subscribe((res: any) => {
    console.log(res);
...
fileupload2(event){
  ...
  Img.onload = (e: any) => {
    ...
    if((height !== 500) && (width !== 500)){
     alert('Please upload the valid height and widht. 500 X 500');
    }else {
   ...
   if(this.time_check == true){
    ...
    this._api.cate_create(a).subscribe(
      (response: any) => {
        //  this.userList = response.Data;
        //  console.log(this.userList);
        alert('Catagoreis Added Successfully');
        this.ngOnInit();
        this.cat_title = '';
        this.cat_descri = '';
        this.cat_image_path = 'http://54.153.8.140:3000/api/uploads/unnamed.jpg';
        this.cat_show_status = true;
        this.cat_day_setting_arr = [];
        this.cat_day_setting_arr1 = [];
        this.cat_day_setting = 'allday';
        this.cat_time_start = '00:00';
        this.cat_time_end = '23:00';
        this.time_check = false;
        this.daysboolean = 'true';
        // this.router.navigateByUrl('admin_panel/vendor_detail');
      }
  ...
  if(check == 1){
    ...
    this._api.cate_edit(a).subscribe(
      (response: any) => {
        //  this.userList = response.Data;
        //  console.log(this.userList);
        alert('Catagoreis Updated Successfully');
        this.ngOnInit();
        this.cat_title = '';
        this.cat_descri = '';
        this.cat_image_path = 'http://54.153.8.140:3000/api/uploads/unnamed.jpg';
