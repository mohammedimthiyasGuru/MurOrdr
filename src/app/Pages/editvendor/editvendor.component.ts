...
export class EditvendorComponent implements OnInit {
  ...
  shoplogo: any = "http://54.153.8.140:3000/api/uploads/unnamed.jpg";
  person_doc : any = "http://54.153.8.140:3000/api/uploads/file.jpg";
  ...
  fileupload1(event){
    ...
    Img.onload = (e: any) => {
      ...
      if((height !== 512) && (width !== 512)){
       alert("Please upload the valid height and widht. 512 X 512");
       this.shoplogos = '';
      }else {
